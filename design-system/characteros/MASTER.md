...
| ---------- | --------- | -------------------- |
| Primary    | `#0056D2` | `--color-primary`    |
| Secondary  | `#E3F2FD` | `--color-secondary`  |
| CTA/Accent | `#0056D2` | `--color-cta`        |
| Background | `#FFFFFF` | `--color-background` |
| Text       | `#1E293B` | `--color-text`       |

**Color Notes:** Light theme only. Professional blue (`#0056D2`) for trust and action.
